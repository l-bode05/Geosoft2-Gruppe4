 ...
 */
    ...
    */ 
    function InsertCommentGeodata($answer_to, $content, $title, $resources, $geodata_link, $user_id, $taglist, $pointx, $pointy, $datestamp, $boundingbox) {
    ...
    */
    function GetUsernameFormatted($id) {
        if($id==0) return "<i>Anonym</i>";
        return "<a href='/final/index.php?user=$id'>" .
                GetUsername($id) . "</a>";
    }
