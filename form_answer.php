    ...
    $(document).ready(function(){
        ...
        $("#answer_form").submit(function(event){
            ...
            if(valid==true) {
                ...
                // Submit Post Request
                $.post('ret_answer.php', $(this).serialize(), function(data){
    ...
    <fieldset style="line-height:0.3">   
           ...
           <?php 
                if(IsLoggedIn()==false) {
                 echo "
                  <div id='userdiv'>
                    <label for='ans_username'>Username:</label>
            ...
            <label for="ans_comment">Resources:</label>
